-- Keep pre-match prediction snapshots keyed off kickoff time instead of fixture status.
-- Some upstream fixture feeds can transiently mark a match live before the real first ball.
